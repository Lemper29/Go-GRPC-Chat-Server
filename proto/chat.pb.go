...
const file_proto_chat_proto_rawDesc = "" +
	"\n" +
	"\x10proto/chat.proto\x12\x04todo\"4\n" +
	"\x04Chat\x12\x12\n" +
	...
	"\bJoinChat\x12\n" +
	".todo.Chat\x1a\n" +
	".todo.Chat(\x010\x01B\tZ\a./protob\x06proto3"
...
var file_proto_chat_proto_goTypes = []any{
	(*Chat)(nil), // 0: todo.Chat
}
var file_proto_chat_proto_depIdxs = []int32{
	0, // 0: todo.ChatService.JoinChat:input_type -> todo.Chat
	0, // 1: todo.ChatService.JoinChat:output_type -> todo.Chat
